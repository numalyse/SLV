...
{
    if (!m_player) return;
    QString captureDirectory = QDir::homePath() + "/SLV_Content/Captures_Images/"+ m_media->fileName() + TimeFormatter::fileFormatMsToHHMMSSFF(getCurrentTime(), m_media->fps()) +".png";
