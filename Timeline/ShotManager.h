...
public:
    ...
    explicit ShotManager(QGraphicsScene *scene, TimelineView *view, TimelineMath *mathManager, Media* media, QVector<Shot> &projectShots, ThumbnailWorker* thumbnailWorker, QObject *parent);
...
private:
    ...
    ThumbnailWorker* p_thumbnailWorker = nullptr; // non owner, partagé avec NavPanel
