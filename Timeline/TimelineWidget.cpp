...
/// @param projectShots
/// @param parent
TimelineWidget::TimelineWidget(Media* projectMedia, PlayerWidget* player, QVector<Shot>& projectShots, ThumbnailWorker* thumbnailWorker, QWidget *parent, const int timelineWidth) : QWidget(parent)
{
    ...
    m_shotManager = new ShotManager(m_scene, m_view, m_mathManager, projectMedia, projectShots, thumbnailWorker, this);
