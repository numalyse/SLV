...
void ExtensionToolbar::addShortcuts()
{
    ...
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("h_flip").toString(), m_horizontalInvBtn, false));
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("v_flip").toString(), m_verticalInvBtn, false));
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("record").toString(), m_recordBtn, false));
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("rotate").toString(), m_rotateBtn, false));
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("hide_img").toString(), m_hideImgBtn));
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("next_frame").toString(), m_nextFrameBtn));
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("prev_frame").toString(), m_prevFrameBtn));
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("forward").toString(), m_forwardBtn));
    m_globalShortcuts.append(SLV::createGlobalButtonShortcut(this, extShortcuts.value("backward").toString(), m_backwardBtn));
